...
function buildCheckoutRequest(appState)
{
    ...
    let successUrl = new URL("https://mrjman006.github.io/gmt-webapps-workshop/latest/success.html");
    successUrl.searchParams.set("purchasedItems", appState.cart.items());
    data.successUrl = successUrl.toString();
   
    let cancelUrl = new URL("https://mrjman006.github.io/gmt-webapps-workshop/latest/cart.html");
