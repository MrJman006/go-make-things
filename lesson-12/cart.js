...
async function handleCheckoutButtonClick(e)
{
    ...
    let success_url = new URL("https://mrjman006.github.io/gmt-webapps-workshop/lesson-12/success.html");
    success_url.searchParams.set("productIds", cart.items());
    requestBodyData.success_url = success_url.toString();
   
    let cancel_url = new URL("https://mrjman006.github.io/gmt-webapps-workshop/lesson-12/cart.html");
