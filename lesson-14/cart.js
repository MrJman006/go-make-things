...
function buildCheckoutRequest(appState)
{
    ...
    let successUrl = new URL("https://mrjman006.github.io/gmt-webapps-workshop/lesson-14/success.html");
    successUrl.searchParams.set("purchasedItems", appState.cart.items());
    data.successUrl = successUrl.toString();
   
    let cancelUrl = new URL("https://mrjman006.github.io/gmt-webapps-workshop/lesson-14/cart.html");
